...
export default function Vortex(props: VortexProps) {
  ...
  // The canvas is created in the mount effect rather than rendered by React:
  // under React strict mode the effect runs mount -> cleanup -> mount against
  // the SAME element, and the cleanup's forceContextLoss poisons it — the
  // second getContext call then yields a lost/stale context that never draws.
  // A fresh canvas per mount sidesteps that entirely.
