...
export const Chapter01Opening: React.FC = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-[100vh] bg-void flex flex-col items-center justify-end pb-0 overflow-y-auto sm:overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 pt-24 pb-4 lg:pb-0">
